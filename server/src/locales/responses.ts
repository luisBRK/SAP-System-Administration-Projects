export const englishResponses = {
  REGISTRATION_ERROR: 'Something went wrong trying to register the user',
  EMAIL_TAKEN: 'This email has been registered before',
  EMAIL_NOT_EXIST: "This email isn't registered",
